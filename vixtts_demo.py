...
def normalize_vietnamese_text(text):
    try:
        ...
        # Create a custom wrapper around TTSnorm that handles Unicode
        with tempfile.NamedTemporaryFile(mode='w', encoding='utf-8', delete=False) as f:
            f.write(text)
            temp_path = f.name
        
        # Now use TTSnorm with the file
        ...
        print(f"Error normalizing Vietnamese text: {str(e)}")
        # If normalization fails, return the original text
        return text
